...
(function() {
  ...
  $(document).ready(function() {
    var $filters, bounds, content_tpl, html_content, infowindow, m, map, mapOptions, markers, org, projects_list, _fn, _fn1, _i, _j, _len, _len1;
    if ($('#map-canvas').length) {
      ...
      _fn = function(org) {
        var prj, _j, _len1, _ref, _results;
        _ref = org.projects;
        _results = [];
    ...
    return $('#OpenLayers_Control_MinimizeDiv').on('click', function() {
